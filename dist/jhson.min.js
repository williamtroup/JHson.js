...
c.clearHTML&&(a.innerHTML=q.empty);F(a,b.result[p],d,c)}}return L}function F(a,c,b,d){var n=b.length,p=[],e;for(e in c)if(G(e,k.attribute)){var f=e.replace(k.attribute,q.empty);a.setAttribute(f,c[e])}else if(G(e,k.cssStyle))f=e.replace(k.cssStyle,q.empty),d.writeCssToHead?p.push(f+":"+c[e]+";"):a.style[f]=c[e];else if(e===k.text){if(a.innerHTML=c[e],0<n)for(f=0;f<n;f++){var g=b[f];d.templateData.hasOwnProperty(g)&&(a.innerHTML=a.innerHTML.replace(new RegExp(g,"g"),d.templateData[g]))}}else if(e===
k.children)for(f=c[e].length,g=0;g<f;g++){var m=c[e][g],l;for(l in m)if(m.hasOwnProperty(l)){var y=H(a,l.toLowerCase());F(y,m[l],b,d)}}if(0<p.length){c=w.getElementsByTagName("head")[0];if(!u(a.id)){b=[];for(d=0;32>d;d++)8!==d&&12!==d&&16!==d&&20!==d||b.push(q.dash),n=B.floor(16*B.random()).toString(16),b.push(n);b=b.join(q.empty);a.id=b}b=[];b.push("#"+a.id+" {");b=b.concat(p);b.push("}");a=H(c,"style");a.type="text/css";a.appendChild(w.createTextNode(b.join(q.newLine)))}}function H(a,c){var b=c.toLowerCase(),
d="text"===b;C.hasOwnProperty(b)||(C[b]=d?w.createTextNode(q.empty):w.createElement(b));b=C[b].cloneNode(!1);a.appendChild(b);return b}function r(a){return null!==a&&void 0!==a&&a!==q.empty}function v(a){return r(a)&&"object"===typeof a}function u(a){return r(a)&&"string"===typeof a}function M(a){return r(a)&&"function"===typeof a}function G(a,c){return a.substring(0,c.length).toLowerCase()===c.toLowerCase()}function t(a,c){return r(a)&&"boolean"===typeof a?a:c}function D(a,c){if(u(a))a=a.split(q.space),
...
z.stringify(d));return d}})();return a};this.html=function(){var a=null;(function(){a=this;var c={json:q.empty,templateData:{},removeAttributes:!0,clearHTML:!0,writeCssToHead:!1};a.json=function(b){var d=c.json;b=u(b)?b:d;c.json=b;return this};a.templateData=function(b){var d=c.templateData;b=v(b)?b:d;c.templateData=b;return this};a.removeAttributes=function(b){c.removeAttributes=t(b,c.removeAttributes);return this};a.clearHTML=function(b){c.clearHTML=t(b,c.clearHTML);return this};a.writeCssToHead=
function(b){c.writeCssToHead=t(b,c.writeCssToHead);return this};a.write=function(b){return J(b,c)}})();return a};this.setConfiguration=function(a){var c=!1,b;for(b in a)a.hasOwnProperty(b)&&h.hasOwnProperty(b)&&a[b]!==h[b]&&(h[b]=a[b],c=!0);c&&I(h);return this};this.getVersion=function(){return"0.4.0"};(function(a,c,b,d){w=a;x=c;z=b;B=d;I();r(x.$jhson)||(x.$jhson=this)})(document,window,JSON,Math)})();