...
y.getVersion=function(){return"1.2.2"};(function(a,b,c,e){x=a;D=b;E=c;K=e;W();x.addEventListener("DOMContentLoaded",function(){L()});v(D.$jhson)||(D.$jhson=y)})(document,window,JSON,Math)})();