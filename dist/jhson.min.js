...
(function(){function E(a,c,b){var d={},l=a.children.length,q=0;if(c.includeAttributes){var k=a.attributes.length;"textarea"===a.nodeName.toLowerCase()&&t(a.value)&&(d[g.text]=a.value);for(var e=0;e<k;e++){var f=a.attributes[e];u(f.nodeName)&&(d[g.attribute+f.nodeName]=f.nodeValue)}}if(c.includeCssProperties&&y.getComputedStyle)for(k=v.defaultView.getComputedStyle(a),e=k.length,f=0;f<e;f++){var h=k[f];if(c.ignoreCssProperties.indexOf(h)===A.notFound){var m=g.cssStyle+h;h=k.getPropertyValue(h);b.hasOwnProperty(m)&&
