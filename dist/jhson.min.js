...
friendlyFormat:!0};this.includeAttributes=function(b){c.includeAttributes=t(b,!0);return this};this.includeCssStyles=function(b){c.includeCssStyles=t(b,!1);return this};this.includeText=function(b){c.includeText=t(b,!0);return this};this.includeChildren=function(b){c.includeChildren=t(b,!0);return this};this.friendlyFormat=function(b){c.friendlyFormat=t(b,!0);return this};this.get=function(b){var d={};b=D(b,c,{});d[b.nodeName]=b.nodeValues;return c.friendlyFormat?z.stringify(d,null,h.jsonIndentationSpaces):
z.stringify(d)}})();return a};this.html=function(){var a=null;(function(){a=this;var c={json:u.empty,templateData:{},removeAttributes:!0,clearHTML:!0};this.json=function(b){c.json=b;return this};this.templateData=function(b){var d={};b=v(b)?b:d;c.templateData=b;return this};this.removeAttributes=function(b){c.removeAttributes=t(b,!0);return this};this.clearHTML=function(b){c.clearHTML=t(b,!0);return this};this.write=function(b){return H(b,c)}})();return a};this.setConfiguration=function(a){var c=
