...
p.hasOwnProperty(b)&&a[b]!==p[b]&&(p[b]=a[b],c=!0);c&&L(p);return this};this.getVersion=function(){return"0.9.0"};(function(a,c,b,d){x=a;z=c;B=b;D=d;L();u(z.$jhson)||(z.$jhson=this)})(document,window,JSON,Math)})();