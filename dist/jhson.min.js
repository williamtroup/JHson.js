...
return c};this.setConfiguration=function(c){var b=!1,a;for(a in c)c.hasOwnProperty(a)&&p.hasOwnProperty(a)&&c[a]!==p[a]&&(p[a]=c[a],b=!0);b&&K(p);return this};this.getVersion=function(){return"0.9.0"};(function(c,b,a,d){y=c;z=b;B=a;C=d;K();v(z.$jhson)||(z.$jhson=this)})(document,window,JSON,Math)})();