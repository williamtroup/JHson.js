...
(a.innerHTML=a.innerHTML.replace(new RegExp(h,"g"),d.templateData[h]))}}else if(e===g.children)for(f=c[e].length,h=0;h<f;h++){var n=c[e][h],w;for(w in n)if(n.hasOwnProperty(w)){var O=H(a,w.toLowerCase());F(O,n[w],b,d,m)}}if(0<l.length){if(u(a.className))c=a.className.split(p.space),c=a.nodeName.toLowerCase()+"."+c[0]+" {";else{if(!u(a.id)){c=[];for(b=0;32>b;b++)8!==b&&12!==b&&16!==b&&20!==b||c.push(p.dash),d=B.floor(16*B.random()).toString(16),c.push(d);c=c.join(p.empty);a.id=c}c="#"+a.id+" {"}b=
[];b.push(c);b=b.concat(l);b.push("}");m.css[a.id]=b}}function M(a){var c=v.getElementsByTagName("head")[0],b=[],d;for(d in a.css)a.css.hasOwnProperty(d)&&(b=b.concat(a.css[d]));a=H(c,"style");a.type="text/css";a.appendChild(v.createTextNode(b.join(p.newLine)))}function L(){for(var a=v.getElementsByTagName("style"),c=a.length,b=0;b<c;b++)a[b].parentNode.removeChild(a[b])}function H(a,c){var b=c.toLowerCase(),d="text"===b;C.hasOwnProperty(b)||(C[b]=d?v.createTextNode(p.empty):v.createElement(b));b=
...
!0,b=null;try{u(a)&&(b=z.parse(a))}catch(d){try{b=eval("("+a+")"),P(b)&&(b=b())}catch(m){k.safeMode||(console.error("Errors in object: "+d.message+", "+m.message),c=!1),b=null}}return{parsed:c,result:b}}function I(a){k=x(a)?a:{};k.safeMode=r(k.safeMode,!0);k.nodeTypesToIgnore=D(k.nodeTypesToIgnore,[]);k.cssPropertiesToIgnore=D(k.cssPropertiesToIgnore,[]);k.formattingNodeTypes=D(k.formattingNodeTypes,"b strong i em mark small del ins sub sup".split(" "))}var N=this,v=null,y=null,z=null,B=null,k={},
C={},p={empty:"",space:" ",newLine:"\n"},g={text:"#text",cssStyle:"$",attribute:"@",children:"&children"},A={notFound:-1};this.json=function(){var a=null;(function(){a=this;var c={includeAttributes:!0,includeCssStyles:!1,includeText:!0,includeChildren:!0,friendlyFormat:!0,indentSpaces:2};a.includeAttributes=function(b){c.includeAttributes=r(b,c.includeAttributes);return this};a.includeCssStyles=function(b){c.includeCssStyles=r(b,c.includeCssStyles);return this};a.includeText=function(b){c.includeText=
...
null;(function(){a=this;var c={json:p.empty,templateData:{},removeAttributes:!0,clearHTML:!0,addCssToHead:!1,clearCssFromHead:!1};a.json=function(b){var d=c.json;b=u(b)?b:d;c.json=b;return this};a.templateData=function(b){var d=c.templateData;b=x(b)?b:d;c.templateData=b;return this};a.removeAttributes=function(b){c.removeAttributes=r(b,c.removeAttributes);return this};a.clearHTML=function(b){c.clearHTML=r(b,c.clearHTML);return this};a.addCssToHead=function(b){c.addCssToHead=r(b,c.addCssToHead);return this};
a.clearCssFromHead=function(b){c.clearCssFromHead=r(b,c.clearCssFromHead);return this};a.write=function(b){return J(b,c)}})();return a};this.setConfiguration=function(a){var c=!1,b;for(b in a)a.hasOwnProperty(b)&&k.hasOwnProperty(b)&&a[b]!==k[b]&&(k[b]=a[b],c=!0);c&&I(k);return this};this.getVersion=function(){return"0.5.0"};(function(a,c,b,d){v=a;y=c;z=b;B=d;I();t(y.$jhson)||(y.$jhson=this)})(document,window,JSON,Math)})();